        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("Semua Tanggal", style: TypographyApp.queueScheduleSelect,),
                      Row(
                        children: [
                          Icon(
              ...
              Text("Hari ini", style: TypographyApp.historyDay,),
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text("13:02", style: TypographyApp.historyClock,),
                          SizedBox(width: 12.w,)
                        ],
                      ),
                    ],
              ...
              SizedBox(height: 24.h,),
              Text("Kemarin", style: TypographyApp.historyDay,),
              Padding(
                padding: EdgeInsets.only(top: 12.h),
                child: ElevatedButton(
                  onPressed: (){},
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text("Kemarin", style: TypographyApp.historyClock,),
                          SizedBox(width: 12.w,)
                        ],
                      ),
                    ],
              ...
              SizedBox(height: 24.h,),
              Text("Lawas", style: TypographyApp.historyDay,),
              Padding(
                padding: EdgeInsets.only(top: 12.h),
                child: ElevatedButton(
                  onPressed: (){},
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text("20/8/23", style: TypographyApp.historyClock,),
                          SizedBox(width: 12.w,)
                        ],
                      ),
                    ],
